...
static const struct kparser_arg_key_val_token parse_node_key_vals[] = {
	[0] {
		...
		.semi_optional = true,
		.other_mandatory_idx = 1,
		.w_offset = offsetof(struct kparser_conf_cmd, node_conf.key.name),
		.w_len = sizeof(((struct kparser_conf_cmd *) NULL)->
				node_conf.key.name),
	},
	[1] {
		...
		.semi_optional = true,
		.other_mandatory_idx = 0,
		.w_offset = offsetof(struct kparser_conf_cmd, node_conf.key.id),
		.w_len = sizeof(((struct kparser_conf_cmd *) NULL)->
				node_conf.key.id),
	},
	{
	...
	KPARSER_ARG_U(32, "unknown_ret", node_conf.plain_parse_node.unknown_ret,
			0, 0xffffffff, 0, "dummy_help"),

	KPARSER_ARG_HKEY("proto_table.name", "proto_table.id",
			node_conf.plain_parse_node.proto_table_key),

	KPARSER_ARG_HKEY("wildcard_parse_node.name", "wildcard_parse_node.id",
			node_conf.plain_parse_node.wildcard_parse_node_key),

	KPARSER_ARG_HKEY("metadata_table.name", "metadata_table.id",
			node_conf.plain_parse_node.metadata_table_key),

	// params for plain parse node
	KPARSER_ARG_BOOL("encap", node_conf.plain_parse_node.proto_node.encap, false),
	KPARSER_ARG_BOOL("overlay", node_conf.plain_parse_node.proto_node.overlay, false),
	KPARSER_ARG_U(64, "min_len", node_conf.plain_parse_node.proto_node.min_len,
			0, 0xffff, 0, "min len"),
	KPARSER_ARG_BOOL("flag_fields_length",
			node_conf.plain_parse_node.proto_node.ops.flag_fields_length, false),
	KPARSER_ARG_BOOL("len_parameterized",
			node_conf.plain_parse_node.proto_node.ops.len_parameterized, false),
	KPARSER_ARG_U(16, "pflen_src_off",
			node_conf.plain_parse_node.proto_node.ops.pflen.src_off,
			0, 0xffff, 0, "src offset"),
	KPARSER_ARG_U(8, "pflen_size",
			node_conf.plain_parse_node.proto_node.ops.pflen.size,
			0, 0xff, 0, "size"),
	KPARSER_ARG_BOOL("pflen_endian",
			node_conf.plain_parse_node.proto_node.ops.pflen.endian, false),
	KPARSER_ARG_U(32, "pflen_mask",
			node_conf.plain_parse_node.proto_node.ops.pflen.mask,
			0, 0xffffffff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "pflen_right_shift",
			node_conf.plain_parse_node.proto_node.ops.pflen.right_shift,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "pflen_multiplier",
			node_conf.plain_parse_node.proto_node.ops.pflen.multiplier,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "pflen_add_value",
			node_conf.plain_parse_node.proto_node.ops.pflen.add_value,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_BOOL("next_proto_parameterized",
			node_conf.plain_parse_node.proto_node.ops.next_proto_parameterized, false),
	KPARSER_ARG_U(16, "pfnext_src_off",
			node_conf.plain_parse_node.proto_node.ops.pfnext_proto.src_off,
			0, 0xffff, 0, "dummy_help"),
	KPARSER_ARG_U(16, "pfnext_mask",
			node_conf.plain_parse_node.proto_node.ops.pfnext_proto.mask,
			0, 0xffff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "pfnext_size",
			node_conf.plain_parse_node.proto_node.ops.pfnext_proto.size,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "pfnext_rightshift",
			node_conf.plain_parse_node.proto_node.ops.pfnext_proto.right_shift,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_BOOL("cond_exprs_parameterized",
			node_conf.plain_parse_node.proto_node.ops.cond_exprs_parameterized, false),
	KPARSER_ARG_HKEY("cond_exprs_table.name", "cond_exprs_table.id",
			node_conf.plain_parse_node.proto_node.ops.cond_exprs_table),

	// params for tlvs parse node
	KPARSER_ARG_U(16, "tlvs_off_src_off",
			node_conf.tlvs_parse_node.proto_node.
	...
	KPARSER_ARG_U(64, "tlvs_start_offset",
			node_conf.tlvs_parse_node.proto_node.start_offset,
			0, 0xffffffffffffffff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "tlvs_pad1_val",
			node_conf.tlvs_parse_node.proto_node.pad1_val,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "tlvs_padn_val", node_conf.tlvs_parse_node.
			proto_node.padn_val, 0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "tlvs_eol_val", node_conf.tlvs_parse_node.
			proto_node.eol_val, 0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_BOOL("tlvs_pad1_enable", node_conf.tlvs_parse_node.
			proto_node.pad1_enable, false),
	KPARSER_ARG_BOOL("tlvs_padn_enable", node_conf.tlvs_parse_node.
			proto_node.padn_enable, false),
	KPARSER_ARG_BOOL("tlvs_eol_enable", node_conf.tlvs_parse_node.
			proto_node.eol_enable, false),
	KPARSER_ARG_BOOL("tlvs_fixed_start_offset",
			node_conf.tlvs_parse_node.proto_node.fixed_start_offset, false),
	KPARSER_ARG_U(64, "tlvs_min_len", node_conf.tlvs_parse_node.proto_node.min_len,
			0, 0xffffffffffffffff, 0, "dummy_help"),

	KPARSER_ARG_U(32, "unknown_tlv_type_ret",
			node_conf.tlvs_parse_node.unknown_tlv_type_ret,
			0, 0xffffffff, 0, "dummy_help"),
	KPARSER_ARG_HKEY("tlv_proto_table.name", "tlv_proto_table.id",
			node_conf.tlvs_parse_node.tlv_proto_table_key),
	KPARSER_ARG_HKEY("tlv_wildcard_node.name", "tlv_wildcard_node.id",
			node_conf.tlvs_parse_node.tlv_wildcard_node_key),


	KPARSER_ARG_U(16, "tlvs_max_loop", node_conf.tlvs_parse_node.config.max_loop,
			0, 0xffff, KPARSER_DEFAULT_TLV_MAX_LOOP, "dummy_help"),
	KPARSER_ARG_U(16, "tlvs_max_non", node_conf.tlvs_parse_node.config.max_non,
			0, 0xffff, KPARSER_DEFAULT_TLV_MAX_NON_PADDING, "dummy_help"),
	KPARSER_ARG_U(8, "tlvs_max_plen", node_conf.tlvs_parse_node.config.max_plen,
			0, 0xff, KPARSER_DEFAULT_TLV_MAX_CONSEC_PAD_BYTES, "dummy_help"),
	KPARSER_ARG_U(8, "tlvs_max_c_pad", node_conf.tlvs_parse_node.config.max_c_pad,
			0, 0xff, KPARSER_DEFAULT_TLV_MAX_CONSEC_PAD_OPTS, "dummy_help"),
	{
		.type = KPARSER_ARG_VAL_SET,
		...
		.w_offset = offsetof(struct kparser_conf_cmd,
				node_conf.tlvs_parse_node.config.
				disp_limit_exceed),
		.w_len = sizeof(((struct kparser_conf_cmd *) NULL)->
				node_conf.tlvs_parse_node.config.
				disp_limit_exceed),
	...
	KPARSER_ARG_BOOL("tlvs_exceed_loop_cnt_is_err",
			node_conf.tlvs_parse_node.config.exceed_loop_cnt_is_err,
			KPARSER_DEFAULT_TLV_EXCEED_LOOP_CNT_ERR),

	// params for flag fields parse node
	KPARSER_ARG_BOOL("flags_get_parameterized",
			node_conf.flag_fields_parse_node.proto_node.ops.get_flags_parameterized,
			false),
	KPARSER_ARG_U(16, "flags_get_src_off",
			node_conf.flag_fields_parse_node.proto_node.ops.pfget_flags.src_off,
			0, 0xffff, 0, "dummy_help"),
	KPARSER_ARG_U(32, "flags_get_mask",
			node_conf.flag_fields_parse_node.proto_node.ops.pfget_flags.mask,
			0, 0xffffffff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "flags_get_size",
			node_conf.flag_fields_parse_node.proto_node.ops.pfget_flags.size,
			0, 0xff, 0, "dummy_help"),

	KPARSER_ARG_BOOL("flags_soff_parameterized",
			node_conf.flag_fields_parse_node.proto_node.ops.
			start_fields_offset_parameterized, false),
	KPARSER_ARG_U(16, "flags_soff_src_off",
			node_conf.flag_fields_parse_node.proto_node.ops.pfstart_fields_offset.src_off,
			0, 0xffff, 0, "src offset"),
	KPARSER_ARG_U(8, "flags_soff_size",
			node_conf.flag_fields_parse_node.proto_node.ops.pfstart_fields_offset.size,
			0, 0xff, 0, "size"),
	KPARSER_ARG_BOOL("flags_soff_endian",
			node_conf.flag_fields_parse_node.proto_node.ops.pfstart_fields_offset.endian, false),
	KPARSER_ARG_U(32, "flags_soff_mask",
			node_conf.flag_fields_parse_node.proto_node.ops.pfstart_fields_offset.mask,
			0, 0xffffffff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "flags_soff_right_shift",
			node_conf.flag_fields_parse_node.proto_node.ops.pfstart_fields_offset.right_shift,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "flags_soff_multiplier",
			node_conf.flag_fields_parse_node.proto_node.ops.pfstart_fields_offset.multiplier,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_U(8, "flags_soff_add_value",
			node_conf.flag_fields_parse_node.proto_node.ops.pfstart_fields_offset.add_value,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_HKEY("flag_fields_table.name", "flag_fields_table.id",
			node_conf.flag_fields_parse_node.proto_node.flag_fields_table_hkey),
	KPARSER_ARG_HKEY("flag_fields_proto_table.name", "flag_fields_proto_table.id",
			node_conf.flag_fields_parse_node.flag_fields_proto_table_key),
};
...
static const struct kparser_arg_key_val_token tlv_parse_node_key_vals[] = {
	...
	KPARSER_ARG_BOOL("is_padding", tlv_node_conf.node_proto.is_padding, false),
	...
	KPARSER_ARG_U(8, "pfoverlay_type_size",
			tlv_node_conf.node_proto.ops.pfoverlay_type.size, 0, 0xff, 0,
			"dummy_help"),
	KPARSER_ARG_U(8, "pfoverlay_type_right_shift",
			tlv_node_conf.node_proto.ops.pfoverlay_type.right_shift,
			0, 0xff, 0, "dummy_help"),
	KPARSER_ARG_HKEY("cond_exprs_table.name", "cond_exprs_table.id",
...
const struct kparser_global_namespaces *g_namespaces[] = {
	...
	[KPARSER_NS_FLAG_FIELD_NODE_PARSE] =
		&kparser_arg_namespace_flag_field_node_parse,
	[KPARSER_NS_FLAG_FIELD_TABLE] = &kparser_arg_namespace_flag_field_table,
